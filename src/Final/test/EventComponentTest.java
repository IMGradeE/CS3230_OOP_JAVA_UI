package Final.test;
import Final.main.EventComponent;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;
import org.mockito.Mockito;
import Final.main.Event;
...
public class EventComponentTest {
    ...
    public void testGetNumberOfLuckyEvents() {
        EventComponent component = new EventComponent(250, 250);
        assertEquals(250, component.getNumberOfLuckyEvents());
    }

    @Test
    public void testGetNumberOfUnluckyEvents() {
        EventComponent component = new EventComponent(250, 250);
        assertEquals(250, component.getNumberOfUnluckyEvents());
    }
